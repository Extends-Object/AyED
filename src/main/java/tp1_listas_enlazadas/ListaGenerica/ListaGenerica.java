...
public abstract class ListaGenerica<T> {
	 ...
	 * **/
	//public abstract ListaGenerica<T> clonar();		//Puede ser generico
...
//----------------------------------------------------------------------------------------------------------------------
	public ListaGenerica<T> clonar(){
		...
		ListaGenerica<T> nueva = crearVacia();
	...
	public abstract ListaGenerica<T> crearVacia ();
...
//----------------------------------------------------------------------------------------------------------------------
	...
	public boolean agregar (T[] array){
		...
		for(T elem : array){
			if (!this.agregarFinal(elem)) {		//primero ejecuta si retorna false retorna si no sigue el loop
				return false;
			}
		}
		return true;
